...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      // Redirect to the page user was trying to access, or default to /plan
          ...
          <form onSubmit={handleSubmit} style={{ position: 'relative', zIndex: 100 }}>
            <div style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                placeholder="traveler@routeiq.com"
                autoComplete="email"
                required
                className="riq-input"
                style={{
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                borderRadius: '0.75rem',
                background: loading ? 'var(--riq-border)' : 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)',
                color: '#fff',
                border: 'none',
